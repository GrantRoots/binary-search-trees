...
class Tree {
  ...
  buildTree(array) {
    ...
    let rightHalf = sortedArray.slice(
...
//testing - uncomment section by section to run

//Shows the full tree visually in the console
...
//can put whatever numbers you would like in the tree
